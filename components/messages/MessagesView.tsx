...
export function MessagesView({
  ...
  // Realtime subscription for user chats
  useEffect(() => {
      ...
      try {
        ...
        if (data.reply) {
          ...
          if (!selected.id && data.conversation_id) {
            ...
            // Refresh mentor conversations list
      ...
      <div className="w-80 border-r border-border/40 flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          <div className="border-b border-border/40">
            ...
            {/* Recent mentor chats */}
            {mentorConvs.length > 0 && (
              <div className="pb-2">
                {mentorConvs.slice(0, 3).map((mc) => (
                  <button
                    key={mc.id}
                    type="button"
                    onClick={() => openMentor(mc.id)}
                    className={cn(
                      'w-full flex items-center gap-3 pl-11 pr-3 py-1.5 hover:bg-muted/30 transition-colors text-left',
                      isMentorSelected && selected?.id === mc.id
                        ? 'bg-muted/50'
                        : ''
                    )}
                  >
              ...
              {activeConvs.map((conv) => {
                ...
                return (
                  <button
                    ...
                    className={cn(
                      'w-full flex items-start gap-3 px-3 py-3 hover:bg-muted/40 transition-colors text-left border-b border-border/40 group relative',
                  ...
                  {archivedConvs.map((conv) => {
                    ...
                    return (
                      <button
                        ...
                        onClick={() => openUserConversation(conv)}
                        className={cn(
                          'w-full flex items-start gap-3 px-3 py-3 hover:bg-muted/40 transition-colors text-left border-b border-border/40 group opacity-70',
                          isUserSelected && selected?.id === conv.id
                            ? 'bg-muted/40'
                            : ''
                        )}
          ...
          <div className="flex-1 flex items-center justify-center">
            <div className="text-center space-y-3 max-w-md">
              ...
              <p className="text-sm text-muted-foreground">
                Select a conversation or start chatting with DSRT Mentor
              </p>
            </div>
          </div>
        ) : isMentorSelected ? (
                  ...
                  <div className="text-center py-8 space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground mt-1 max-w-sm mx-auto">
                        I&apos;m your DSRT Mentor. I know your profile, your
                        ventures, and I&apos;m here to help you build. What&apos;s on
                        your mind?
                      </p>
                    </div>
