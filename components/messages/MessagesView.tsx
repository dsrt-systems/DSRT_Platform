                  ...
                  <div className="text-center py-8 space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground mt-1 max-w-sm mx-auto">
                        I&apos;m your DSRT Mentor. I know your profile and your ventures. What&apos;s on your mind?
                      </p>
                    </div>
                    ...
                    <div key={m.id} className="flex gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-1.5 mb-1">
                          ...
                          {m.role === 'assistant' && (
                            <svg viewBox="0 0 24 24" className="w-3 h-3 text-emerald-500" fill="currentColor">
                              <path d="M9.5 16.5L4 11l1.4-1.4L9.5 13.7l9.1-9.1L20 6l-10.5 10.5z" />
                            </svg>
                          )}
                        </div>
