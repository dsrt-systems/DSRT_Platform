  ...
  return (
    <>
      ...
      <div className="relative rounded-2xl overflow-hidden bg-white/[0.02] border border-white/[0.06] mb-4">
          ...
          <div className="absolute inset-x-0 bottom-0 px-6 md:px-8 pb-6 md:pb-7 z-10">
            <div className="flex items-end gap-5">
              ...
              <div className="flex-1 min-w-0 pb-1">
                ...
                {/* Compact stat line — GitHub-style, mobile-responsive */}
                <div
              ...
              <div className="hidden md:flex items-center gap-2 flex-shrink-0 self-end mb-1">
                {!isOwner && (
                  <>
                    <button
                      onClick={onMessage}
                      className="flex items-center gap-1.5 text-[12.5px] font-semibold text-white bg-white/[0.1] backdrop-blur-md border border-white/[0.2] hover:bg-white/[0.15] px-3 h-9 rounded-lg transition-colors"
                    >
        ...
        {/* Mobile action bar — fixed for narrow screens (equal 3-column grid) */}
        {!isOwner && (
          <div className="md:hidden px-4 py-3 border-t border-white/[0.06] grid grid-cols-3 gap-2">
            <button
              onClick={onMessage}
              className="text-[11.5px] font-semibold text-white bg-white/[0.05] border border-white/[0.08] hover:bg-white/[0.1] h-9 rounded-lg transition-colors"
            >
              Message
            </button>
            <button
