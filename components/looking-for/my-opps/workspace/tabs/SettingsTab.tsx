          ...
          <div className="flex flex-wrap gap-2">
            {['active', 'paused', 'closed', 'filled', 'archived'].map((s) => (
              <button
                ...
                className={
                  'h-9 px-3 rounded-xl border text-[12px] font-semibold capitalize ' +
                  (opp.status === s
        ...
        <Card title="Danger zone">
          <div className="space-y-2">
            <button
              ...
              className="h-9 px-4 rounded-xl border border-zinc-800 text-[12.5px] font-semibold text-zinc-300 hover:text-white hover:border-zinc-600"
            >
              Archive
            </button>
            <button
              ...
              className="ml-2 h-9 px-4 rounded-xl border border-red-500/30 bg-red-500/10 text-red-300 text-[12.5px] font-semibold hover:bg-red-500/15"
            >
              Delete
            </button>
          </div>
