  ...
  return (
    <div className="space-y-4">
      <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-3">
        <KpiCard label="Applicants" value={opp.application_count || 0} />
        <KpiCard label="Qualified" value={opp.qualified_count || 0} />
        <KpiCard label="Shortlisted" value={opp.shortlisted_count || 0} />
        <KpiCard label="Interviewing" value={opp.interviewing_count || 0} />
        <KpiCard label="Selected" value={opp.selected_count || 0} />
        <KpiCard label="Conversion" value={`${opp.conversion_rate || 0}%`} />
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_0.8fr] gap-4">
        ...
        <Section
          title="Quick actions"
          subtitle="Jump to the right place"
        >
          <div className="grid grid-cols-2 gap-2">
            <QuickBtn onClick={() => onChangeTab('applicants')} label="Review applicants" hint={`${opp.application_count || 0} total`} />
