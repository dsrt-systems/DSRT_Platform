...
export function ProjectSortDropdown({ value, onChange }: Props) {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute right-0 top-full mt-1 z-40 w-56 bg-[#0d0d10] border border-white/[0.1] rounded-xl shadow-2xl py-1">
