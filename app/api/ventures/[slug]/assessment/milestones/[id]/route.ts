...
export async function PATCH(
  ...
  const allowed = ['title', 'description', 'target_date', 'success_criteria', 'status', 'is_primary', 'position']
...
export async function DELETE(
  ...
  await supabase.from('venture_milestones').delete().eq('id', id).eq('venture_id', venture.id)
