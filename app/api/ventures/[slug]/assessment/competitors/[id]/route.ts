...
export async function PATCH(
  ...
  const allowed = ['competitor_name', 'competitor_type', 'strengths', 'weaknesses', 'position']
...
export async function DELETE(
  ...
  await supabase.from('venture_competitors').delete().eq('id', id).eq('venture_id', venture.id)
